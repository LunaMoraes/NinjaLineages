...
NinjaLineages.Balance.Jinchuuriki.Sealing = {
    ...
    RITUAL_RADIUS = 50.0,
    BASE_PROGRESS_PER_GAME_MINUTE = 3.7037037,
    TAIL_RESISTANCE_PER_ADDITIONAL_TAIL = 0.125,
    CONTAINMENT_MULTIPLIER = 1.15,
    SEAL_REINFORCEMENT_MULTIPLIER = 1.20,
    PROGRESS_SYNC_DELTA = 0.25,
    PROGRESS_SYNC_INTERVAL_GAME_MINUTES = 0.25,
    DEBUG_RESTRAINT_STRENGTH = 0.50,
    DEBUG_RESTRAINT_DURATION_GAME_MINUTES = 5.0,
}
